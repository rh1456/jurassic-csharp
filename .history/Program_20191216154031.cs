...
namespace jurassic_csharp
{
  class Program
  {
    ...
    static void AddDino()
    {
      ...
      Db.Dinosaur.Add(dino);
      Db.SaveChanges();
    }

    static void ViewAll()
    {
      DisplayListOfDinosaur(Db.Dinosaur);
    ...
    static void TransferDino()
    {
      ...
      var enclosure = Console.ReadLine();
      var changeEnclosure = Db.Dinosaur.FirstOrDefault(dino => dino.Name.ToLower() == dinoName.ToLower());
    ...
    static void SortByWeight()
    {
      ...
      Console.WriteLine("-------");
      DisplayListOfDinosaur(Db.Dinosaur.OrderByDescending(dino => dino.Weight).Take(3));
      Console.WriteLine("---------");
    }
    static void SortByDiet()
    {
      ...
      var dinoDiet = Db.Dinosaur.Count(dino => dino.DietType.ToLower() == dinoDietType.ToLower());
